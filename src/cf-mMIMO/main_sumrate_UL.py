'''
This file training heterogenous QGNN (batched) for uplink sum-rate cf-mMIMO
...
def get_args():
    ...
    parser.add_argument('--cen_pretrain', type=str, default=None,
...
if __name__ == '__main__':
    ...
    #             train_loader_cen, qgnn_model, qgnn_optimizer,
    ...
    #                 train_loader_cen, qgnn_model,
    #                 tau=tau, rho_p=rho_p, rho_d=rho_d, num_antenna=num_antenna
    #             )
    #             test_eval = cen_eval_sumrate(
    #                 test_loader_cen, qgnn_model,
    #                 tau=tau, rho_p=rho_p, rho_d=rho_d, num_antenna=num_antenna
    #             )
    ...
    if args.eval_plot:
        ...
        for batch in eval_loader_cen:
            ...
            qgnn_rates, _ = cen_loss_function_sumrate(
